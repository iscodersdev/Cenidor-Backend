...
{
    [Area("Core")]
    public class NovedadesController : CenidorCoreController
    {
        NotificacionAPIService _notificacionPush;
        public NovedadesController(CenidorContext context, NotificacionAPIService notificacionPush) : base(context)
        {
