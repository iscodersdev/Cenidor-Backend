...
{
    [Area("Core")]
    public class VendedoresController : CenidorCoreController
    {
        private readonly UserService<Usuario> _userService;
        public VendedoresController(CenidorContext context, UserService<Usuario> userService) : base(context)
        {
