...
namespace CenidorCore.Services
{
    public class Estancias
    {
        ...
        public static Clientes CompruebaUsuarioEstancias(int DNI, CenidorContext _context)
        {
        ...
        public static Clientes CompruebaUsuarioEstancias20(string eMail, CenidorContext _context)
        {
            Clientes persona = new Clientes();
            string uat = LoginEstancias();
            using (var client = new HttpClient())
