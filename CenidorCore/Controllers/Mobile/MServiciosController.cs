...
namespace CenidorCore.Controllers
{
    ...
    public class MServiciosController : BaseController
    {
        ...
        public MServiciosController(CenidorContext context, UserService<Usuario> userManager)
        {
            _context = context;
        ...
        public MGrabaReservaDTO GrabaReserva([FromBody] MGrabaReservaDTO uat)
        {
            ...
            common.EnviarMail(Uat.Cliente.Usuario.Mail, "Confirma Reserva Actividad", textomail, "Cenidor", null,null);
            return uat;
        }
        ...
        public MAnulaReservaDTO AnulaReserva([FromBody] MAnulaReservaDTO uat)
        {
            ...
            common.EnviarMail(Uat.Cliente.Usuario.Mail, "Anulacion Reserva Actividad", textomail, "Cenidor", null,null);
            return uat;
        }
    }
}
