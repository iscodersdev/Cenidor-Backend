...
namespace CenidorCore.API.Controllers.Billetera
{
    ...
    public class MPagosController : BaseApiController
    {
        private readonly NotificacionAPIService _notificacionAPIService;

        public MPagosController(CenidorContext context, NotificacionAPIService notificacionAPIService) : base(context)
        {
