...
{
    public class CenidorCoreController : BaseController
    {
        ...
        public CenidorCoreController(CenidorContext context)
        {
            _context = context;
            breadcumb.Add(new Message() { DisplayName = "Inicio", URLPath = "/Home/Index", FontAwesomeIcon = "archway" });
        }
        public CenidorCoreController(CenidorContext context, IHostingEnvironment env)
        {
            _context = context;
            _env = env;
        }
        public CenidorCoreController(CenidorContext context, UserManager<Usuario> userManager)
        {
            _context = context;
